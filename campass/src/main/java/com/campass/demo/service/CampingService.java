...
@Value("http://localhost:8087/seller/images/")
...
//upload photo    🔽🔽🔽🔽🔽 path name 
	...
	//나의예약내역 (판매회원)   myReviewDto 안에 한번더 체크하기 엄청 난게 들었다. 난이도 최상! 상관서브쿼리 챙기기 + th:if문 챙기기 + dto를 따로만들어서 데이터항목(컬럼)을 하나 추가해서 화면에 t or f 역할로 뿌려준다 0이면 나오고 1이면 나오지 못하게하는 항목
	public List<MyReservationDto> mymyCamping(Reservation reservation, String loginId) {
